# Card-Decks Requirements

Please create a RESTful microservice that implements a card shuffling algorithm, as defined below.  Show evidence of test-driven development with unit tests.
